 ...
 */
final class Version20221207170158 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movie DROP type_id, DROP genre_id');
        $this->addSql('DROP INDEX IDX_AA3A93344296D31F ON serie');
        $this->addSql('DROP INDEX IDX_AA3A9334C54C8C93 ON serie');
        $this->addSql('ALTER TABLE serie DROP type_id, DROP genre_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movie ADD type_id INT DEFAULT NULL, ADD genre_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE serie ADD type_id INT NOT NULL, ADD genre_id INT NOT NULL');
